...
execute as @a[tag=GettingNewLeaderboardFast] at @s as @e[type=marker,tag=lb] if score @s TRACK = @p TRACK at @s run summon minecraft:text_display ~ ~ ~ {alignment:"center",text:'[{"selector":"@a[tag=GettingNewLeaderboardFast]","color":"aqua"},{"text":" - ","color":"aqua"},{"score":{"name":"@a[tag=GettingNewLeaderboardFast]","objective":"MINUTES2"},"color":"aqua"},{"score":{"name":"@a[tag=GettingNewLeaderboardFast]","objective":"MINUTES1"},"color":"aqua"},{"text":":","color":"aqua"},{"score":{"name":"@a[tag=GettingNewLeaderboardFast]","objective":"SECONDS2"},"color":"aqua"},{"score":{"name":"@a[tag=GettingNewLeaderboardFast]","objective":"SECONDS1"},"color":"aqua"},{"text":":","color":"aqua"},{"score":{"name":"@a[tag=GettingNewLeaderboardFast]","objective":"PARTIAL2"},"color":"aqua"},{"score":{"name":"@a[tag=GettingNewLeaderboardFast]","objective":"PARTIAL1"},"color":"aqua"}]',Tags:["lbf","newF","LB"],Rotation:[180f,0f]}
