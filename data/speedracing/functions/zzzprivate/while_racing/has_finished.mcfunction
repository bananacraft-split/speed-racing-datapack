...
execute if data storage minecraft:options {200CC:0b} at @s as @e[type=minecraft:text_display,tag=lbs] if score @s ID = @p ID if score @s TRACK = @p TRACK if score @s TIME > @p TIME run function speedracing:zzzprivate/leaderboard/delete_leaderboard_slow
execute if data storage minecraft:options {200CC:0b} at @s as @e[type=minecraft:text_display,tag=lbs] if score @s ID = @p ID if score @s TRACK = @p TRACK run tag @p add skip
execute if data storage minecraft:options {200CC:0b} unless entity @s[tag=skip] run function speedracing:zzzprivate/leaderboard/make_leaderboard_slow

execute if data storage minecraft:options {200CC:1b} at @s as @e[type=minecraft:text_display,tag=lbf] if score @s ID = @p ID if score @s TRACK = @p TRACK if score @s TIME > @p TIME run function speedracing:zzzprivate/leaderboard/delete_leaderboard_fast
execute if data storage minecraft:options {200CC:1b} at @s as @e[type=minecraft:text_display,tag=lbf] if score @s ID = @p ID if score @s TRACK = @p TRACK run tag @p add skip
execute if data storage minecraft:options {200CC:1b} unless entity @s[tag=skip] run function speedracing:zzzprivate/leaderboard/make_leaderboard_fast
