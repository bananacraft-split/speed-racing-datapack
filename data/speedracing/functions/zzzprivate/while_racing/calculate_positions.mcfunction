execute as @a[tag=RaceInProgress] run function speedracing:zzzprivate/while_racing/calculate_distances
...
execute as @a[tag=RaceInProgress,scores={NEXTD=0..}] at @e[tag=RootEntity,limit=1] run function speedracing:zzzprivate/while_racing/new_cp
