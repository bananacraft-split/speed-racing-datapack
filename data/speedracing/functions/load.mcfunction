...
execute unless data storage options {Loaded:1b} run data merge storage tracks {TrackData:[{id:1,Name:"Alex Circuit",StartPos:{x:2.43d,y:76.00d,z:88.99d,pitch:-361.29f,yaw:6.15f},DayTime:12345,Weather:{Clear:1b},Music:{},Gate:{Make:"fill 3 78 93 1 80 93 green_concrete", Destroy:"fill 3 78 93 1 80 93 air"}}]}
