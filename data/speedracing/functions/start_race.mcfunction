...
function speedracing:zzzprivate/race_start/load_selected_track
...
execute as @e[tag=RaceStartTeleportMarker,limit=1] run function speedracing:zzzprivate/race_start/tp_players_to_track_start
...
function speedracing:zzzprivate/race_start/update_time
...
schedule function speedracing:zzzprivate/race_start/start_cutscene 24
schedule function speedracing:zzzprivate/race_start/mid_cutscene 64

schedule function speedracing:zzzprivate/race_start/end_cutscene 224
schedule function speedracing:zzzprivate/race_start/countdown_three 264
schedule function speedracing:zzzprivate/race_start/countdown_two 284
schedule function speedracing:zzzprivate/race_start/countdown_one 304
schedule function speedracing:zzzprivate/race_start/go 324
